...
void Lecteur::chargerDiaporama()
{
    ...
    Image* imageACharger;
    imageACharger = new Image(3, "personne", "Blanche Neige", ":/imagesDisney/cartesDisney/Disney_4.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(2, "personne", "Cendrillon", ":/imagesDisney/cartesDisney/Disney_21.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "animal", "Mickey", ":/imagesDisney/cartesDisney/Disney_19.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "personne", "Mulan", ":/imagesDisney/cartesDisney/Disney_24.gif");
    _diaporama.push_back(imageACharger);
