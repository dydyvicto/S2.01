...
{
    QMessageBox::information(this, "A propos", "Bonjour, ceci est la version 5 du lecteur de diaporama,"
                             "créée le 04/06/2023 par Dylan Victoras, Yannis Duvignau et Nicolas Conguisti");
}
