...
void Lecteur::chargerDiaporama()
{
    ...
    Image* imageACharger;
    imageACharger = new Image(3, "personne", "Blanche Neige", ":/v2/cartesDisney/Disney_4.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(2, "personne", "Cendrillon", ":/v2/cartesDisney/Disney_21.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "animal", "Mickey", ":/v2/cartesDisney/Disney_19.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "personne", "Mulan", ":/v2/cartesDisney/Disney_24.gif");
    _diaporama.push_back(imageACharger);
